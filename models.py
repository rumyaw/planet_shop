...
class Product(db.Model):
    ...
    @property
    def image_src(self):
        """URL изображения товара для шаблонов.

        Хранит имя локального файла в static/uploads/products/.
        Поддерживает и устаревшие внешние ссылки (http/https) на случай,
        если миграция изображений ещё не выполнялась.
        """
